...
# Carica il CSV
df = pd.read_csv("src/fire/eliminateNoData/pixel_nodata_pre.csv")  # Sostituisci con il tuo nome file
...
yes_rows["file_path"].to_csv("src/fire/eliminateNoData/ToBeDeletedPre.txt", index=False, header=False)
