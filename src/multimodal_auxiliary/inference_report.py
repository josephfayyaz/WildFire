...
DEFAULT_NEW_CKPT = THIS_DIR / "checkpoints" / "best_model_4.pth"
DEFAULT_OLD_CKPT = PROJECT_ROOT / "src" / "multimodal" / "checkpoints" / "best_model_3.pth"
DEFAULT_OUT_DIR = PROJECT_ROOT / "docs" / "case-studies" / "inference-report"
...
def infer_code_dir_from_ckpt(ckpt_path: str) -> Optional[str]:
    """
    If ckpt is like src/multimodal/checkpoints/best_model_3.pth -> infer src/multimodal
    """
