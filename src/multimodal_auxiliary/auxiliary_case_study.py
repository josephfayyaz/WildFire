...
DEFAULT_OUT_DIR = PROJECT_ROOT / "docs" / "case-studies" / "auxiliary-impact"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--ckpt_new", type=str, default=str(DEFAULT_NEW_CKPT))
    p.add_argument("--ckpt_old", type=str, default=str(DEFAULT_OLD_CKPT))
