...
CHECKPOINT_DIR = "checkpoint_main"
LOG_DIR_BASE = "runs"

model_name = "best_model_4.pth"
...
W_LANDCOVER = 0.10  # auxiliary landcover loss weight (set 0 to disable multitask)
...
# --- Calibrated from your ablation_results.csv ---
# Modality order: [Sentinel, Landsat, Other(DEM+streets+ignition), ERA5_raster, ERA5_tabular]
# Relative importance computed from IoU drop when ablating each modality.
MODALITY_WEIGHTS = [1.00, 1.00, 0.42, 0.50, 0.33]

# Best validation threshold from ablation (FULL setting) for binarizing sigmoid outputs.
THRESHOLD_BA = 0.95
