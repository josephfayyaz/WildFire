...
DEFAULT_CKPT = THIS_DIR / "checkpoints" / "best_model_4.pth"
DEFAULT_OUT_DIR = PROJECT_ROOT / "docs" / "case-studies" / "landcover-demo"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--ckpt", type=str, default=str(DEFAULT_CKPT), help="Checkpoint with auxiliary head")
    p.add_argument("--out_dir", type=str, default=str(DEFAULT_OUT_DIR), help="Output folder")
